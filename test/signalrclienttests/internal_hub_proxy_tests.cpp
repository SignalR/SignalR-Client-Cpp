...
{
    internal_hub_proxy hub_proxy { _XPLATSTR("hub"), logger{ std::make_shared<trace_log_writer>(), trace_level::none } };
    try
    {
...
TEST(invoke_event, logs_if_no_handler_for_an_event)
{
    ...
    internal_hub_proxy hub_proxy{ _XPLATSTR("hub"), logger{ writer, trace_level::info } };
