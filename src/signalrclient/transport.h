...
namespace signalr
{
    ...
    protected:
        transport(std::shared_ptr<connection_impl> connection, std::function<void(const utility::string_t &)> process_message);
    ...
    private:
        std::function<void(const utility::string_t &)> m_process_message;
    };
}